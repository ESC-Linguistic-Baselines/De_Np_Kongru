...
def get_config_data(file: str = None) -> dict:
    ...
    :return
       config_data (dict): Ein Python-Wörterbuch mit den Konfigurationsdaten.

    """
    if file is None:
        # Ermittle das Verzeichnis, in dem das Skript sich befindet
        script_verzeichnis = os.path.dirname(os.path.abspath(__file__))
        # Konstruiere den Pfad zur YAML-Konfigurationsdatei relativ zum Verzeichnis
        # des Skripts
