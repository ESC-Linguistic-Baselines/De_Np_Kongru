...
class Statistics:
    ...
    def get_file_header(self):
        ...
        header_results, merlin_meta_data = dict(), list()
    ...
    def count_congruency_codes(self):
        ...
        data_set = {
            ...
            "PREP": {"2": 0, "12": 0},
            "EIGENNAMEN": {"3": 0},
            "REDEWENDUNGEN": {"4": 0, "15": 0},
            "WAHR": 0,
            "FALSCH": 0,
            "UNBEKANNT": 0
        }

        # Assuming np_result_data is a list of lists with the first element being the code
        for row in np_result_data:
            ...
            if code == 0:
                ...
                data_set["REDEWENDUNGEN"]["15"] += 1
            else:
                data_set["UNBEKANNT"] += 1
